...
const STORAGE_KEY = 'yahtzee-scoreboard';
...
const Scoreboard = () => {
    ...
    useEffect(() => {
        ...
        if (saved) {
            const {players, categories} = JSON.parse(saved);
            setPlayers(players);
    ...
    useEffect(() => {
        localStorage.setItem(STORAGE_KEY, JSON.stringify({players, categories}));
    }, [players, categories]);
                        ...
                        <tr key={categoryIndex}>
                            ...
                            {players.map(player => (
                                <td key={player.id} className="border border-gray-300 dark:border-gray-600 px-4 py-2">
                                    <input
                                        type="number"
                                        className="w-16 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block mx-auto p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
